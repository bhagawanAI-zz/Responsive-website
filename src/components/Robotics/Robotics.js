                ...
                <div className="container">
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-12 pb-30">
                            <div className="about-section-item about-item-details">
                                <div className="section-title section-title-left text-start">
                                    <h2>AI Powered Robots with our proven Models</h2>
                                </div>
                                <div className="about-content">
                                ...
                                <div className="section-title section-title-left text-start mt-5 mb-0">
                                    <small className="mb-0">Vision and Imaging Imporvement</small>
                                    ...
                                    <small className="mb-0">Grasping and Manipulation Improvement</small>
                                    ...
                                    <small className="mb-0">Applications</small>
