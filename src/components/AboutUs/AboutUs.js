                        ...
                        <div className="col-lg-6 pb-30">
                            <div className="about-section-item about-item-details">
                                <div className="section-title section-title-left text-start">
                                    <h2>Smarttrak AI is a technology solutions company focused on.</h2>
                                </div>
                                <div className="about-content">
                                    <ul>
                                        <li>Revolutionising the businesses with Advanced AI</li>
                                        <li>Intelligent and predictive assets monitoring</li>
                                    </ul>
                                    <p>We help businesses to lead the charge to digital innovation and tap into the power of the AI by transforming  teams and creating a competitive advantage that will scale.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="about-section-item about-item-details">
                                ...
                                <div className="section-title section-title-left text-start mt-3 mb-0">
                                    ...
                                    <p>We believe a better future can only be achieved with today’s input in life.
                                        ...
                                        We need to give leaders the time, space and resources to think if we want business to drive sustainability transformation.</p>
                                </div>
                            </div>
                        </div>
                    </div>
